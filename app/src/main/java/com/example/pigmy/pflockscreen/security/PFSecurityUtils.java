...
public class PFSecurityUtils implements IPFSecurityUtils {
    ...
    private Cipher getCipherInstance() throws PFSecurityException {
        try {
            ...
            e.printStackTrace();
            throw new PFSecurityException("Can not get instance of Cipher object" + e.getMessage(), PFSecurityUtilsErrorCodes.ERROR_GET_CIPHER_INSTANCE
            );
        }
    }
    ...
    private void initDecodeCipher(Cipher cipher, String alias) throws PFSecurityException {
        try {
            ...
            e.printStackTrace();
            throw  new PFSecurityException("Error init decode Cipher: " + e.getMessage(), PFSecurityUtilsErrorCodes.ERROR_INIT_DECODE_CIPHER
            );
        }
    ...
    private void initEncodeCipher(Cipher cipher, String alias, KeyStore keyStore)
        ...
        try {
            ...
            throw new PFSecurityException("Can not initialize Encode Cipher:" + e.getMessage(), PFSecurityUtilsErrorCodes.ERROR_INIT_ENDECODE_CIPHER
            );
        }
    }
    ...
    public boolean isKeystoreContainAlias(String alias) throws PFSecurityException {
        ...
        try {
            ...
            e.printStackTrace();
            throw new PFSecurityException(e.getMessage(), PFSecurityUtilsErrorCodes.ERROR_KEY_STORE
            );
        }
    }
    ...
    public void deleteKey(String alias) throws PFSecurityException {
        ...
        try {
            ...
            e.printStackTrace();
            throw new PFSecurityException("Can not delete key: " + e.getMessage(), PFSecurityUtilsErrorCodes.ERROR_DELETE_KEY
            );
        }
    }
