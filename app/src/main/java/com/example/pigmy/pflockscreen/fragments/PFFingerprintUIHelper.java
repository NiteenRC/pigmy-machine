...
public class PFFingerprintUIHelper extends FingerprintManagerCompat.AuthenticationCallback {
    ...
    public void onAuthenticationSucceeded(FingerprintManagerCompat.AuthenticationResult result) {
        ...
        mErrorTextView.setText(mErrorTextView.getResources().getString(R.string.fingerprint_success_pf));
        mIcon.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    private Runnable mResetErrorTextRunnable = new Runnable() {
        ...
        public void run() {
            ...
            mErrorTextView.setText(mErrorTextView.getResources().getString(R.string.fingerprint_hint_pf));
            mIcon.setImageResource(R.drawable.fingerprint_lockscreen_pf);
        }
    };
